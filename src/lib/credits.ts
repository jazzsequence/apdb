...
export const ROLE_LABEL =
  /^(actor|actress|self|host|guest|guest star|self\s*[-–—,]\s*\w+|narrator|announcer|storyteller|story teller|game ?master|dungeon ?master|gm|dm|keeper|marshall?|judge|referee|crew|player|cast|various|additional voices)$/i;
